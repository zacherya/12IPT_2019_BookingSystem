...
?>
		...
		<div class="row items away" id="processHeader">
			...
			<div class="col-xs-12">
				<div class="progress">
  				<div class="progress-bar progress-bar-success progress-bar-striped" id="stageprocess" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width:20%">
    				1/5
  				</div>
				</div>
				<h1 <?php if($mobile){echo("style='text-align:center;'");} ?>>Who is loaning the item/s?</h1>
			</div>
		</div>
		<hr>
		...
		<div class="row items away hidden" style="margin-top:35px;" id="s4" data-stage="4" active="false">
			<div class="items-body" style="margin-left:0;text-align:center;">
				<div class="col-xs-12" style="margin-bottom:30px;" id="s4_cfmqty">
					<div data-belong_stage="4" class="items-cell">
						<h3 class="items-title">Confirm Quantities</h3>
					</div>
				</div>

				<div class="col-xs-12" style="margin-bottom:10px;">
					<table class="table table-striped table-condensed" id="s4_table">
						<!--Info Generated Here-->
					</table>
				</div>
			</div>
		...
		<div class="row items away hidden" style="margin-top:35px;" id="s5" data-stage="5" active="false">
			<div class="items-body" style="margin-left:0;text-align:center;">
				<div class="col-xs-12" style="margin-bottom:10px;">
					<h3>Please pay attention to the below return dates, an email has been sent to the user the items were loaned to!</h3>
				</div>
				<div class="col-xs-12" style="margin-bottom:10px;">
					<table class="table table-striped table-condensed" id="s5_table">
						<!--Info Generated Here-->
					</table>
				</div>
			</div>
